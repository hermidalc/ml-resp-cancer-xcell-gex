...
parser.add_argument('--test-size', type=float, default=0.2, help='outer splits test size')
...
parser.add_argument('--filt-nzvr-feat-freq-cut', type=str, help='filter near zero var features freq cutoff')
...
parser.add_argument('--filt-nzvr-sample-freq-cut', type=str, help='filter near zero var sample freq cutoff')
...
pipelines = {
    ...
    'clf': {
        ...
        'KernelSVM': {
            'steps': [
                ('clf', SVC(cache_size=args.clf_svm_cache, random_state=args.random_seed)),
            ],
            'param_grid': [
                {
                    'clf__C': CLF_SVM_C,
        ...
        'ExtraTrees': {
            'steps': [
                ('clf', ExtraTreesClassifier(random_state=args.random_seed)),
            ],
            'param_grid': [
                {
        ...
        'GradientBoost': {
            'steps': [
                ('clf', GradientBoostingClassifier(random_state=args.random_seed)),
            ],
            'param_grid': [
                {
        ...
        'MLP': {
            'steps': [
                ('clf', MLPClassifier(random_state=args.random_seed)),
            ],
            'param_grid': [
                {
